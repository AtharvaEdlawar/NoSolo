...
function App() {
  ...
  return (
    <>
      <Navbar />
      <Hero />
      <Content header={"Welcome to the Spooky Halloween Event"} para={"Join us for a night of fright and fun Join us for a night of fright and fun Join us for a night of fright and fun Join us for a night of fright and fun"} imagesrc={"https://storage.googleapis.com/uxpilot-auth.appspot.com/b29814cf57-3b32ff9ae750d2a48f86.png"} mainDivStyle={"content"} imageStyle={"contentImg"} />
